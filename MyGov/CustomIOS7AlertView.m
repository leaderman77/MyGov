...
- (UIView *)createContainerView
{
    if (containerView == NULL) {
        containerView = [[UIView alloc] initWithFrame:CGRectMake(0, 150, 320, 480)];
    }
    ...
    UIView *dialogContainer = [[UIView alloc] initWithFrame:CGRectMake((screenSize.width - dialogSize.width) / 2, 10, dialogSize.width, self.frame.size.height)];
    ...
    */
    ...
    //dialogContainer.backgroundColor = [UIColor orangeColor];
    [dialogContainer addSubview:containerView];
    
    // Add the buttons too
    //[self addButtonsToView:dialogContainer];
    
    UIButton *bgBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, dialogContainer.frame.size.width, dialogContainer.frame.size.height)];
    
    [bgBtn addTarget:self action:@selector(backButton:) forControlEvents:UIControlEventTouchUpInside];
    //[bgBtn setBackgroundColor:[UIColor greenColor]];
    [dialogContainer insertSubview:bgBtn belowSubview:containerView];
