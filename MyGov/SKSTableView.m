...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (![self.expandedIndexPaths[indexPath.section] containsObject:indexPath]) {
        ...
        cell.backgroundView = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"check_box_bg.png"] stretchableImageWithLeftCapWidth:0.0 topCapHeight:5.0]]; //nil;
